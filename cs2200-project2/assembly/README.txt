The LC-2199a Assembler
===============

To aid in testing your processor, we have provided an *assembler* and
a *simulator* for the LC-2199a architecture. The assembler supports
...
the assembler. The LC-2199a assembler definition is included.

Included Files
-----------

* `assembler.py`: the main assembler program
* `lc2199a.py`: the LC-2199a assembler definition
...
To output assembled code in hexadecimal (for use with *CircuitSim*):
    ...
    python assembler.py -i lc2199a --hex test.s
