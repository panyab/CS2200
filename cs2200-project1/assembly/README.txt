The LC-2199 Assembler and Simulator
===============

To aid in testing your processor, we have provided an *assembler* and
a *simulator* for the LC-2199 architecture. The assembler supports
...
the assembler. The LC-2199 assembler definition is included.

Included Files
-----------

* `assembler.py`: the main assembler program
* `lc2199.py`: the LC-2199 assembler definition
* `lc2199-sim.py`: the LC-2199 simulator program
...
Example usage to assemble `test.s`:
    ...
    python assembler.py -i lc2199 --sym test.s
...
To output assembled code in hexadecimal (for use with *CircuitSim*):
    ...
    python assembler.py -i lc2199 --hex test.s
...
In addition to the syntax described in the LC-2199 ISA reference,
